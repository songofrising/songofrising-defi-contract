...
// The Bank is full of rewards and rubies.
// The longer you stay, the more Rubies you end up with when you leave.
// This contract handles swapping to and from xRubyToken <> RubyToken
contract Bank is ERC20 {
    ...
    // Enter the bank. Deposit some Rubies. Earn some shares.
    ...
    // Leave the bar. Claim back your Rubies.
